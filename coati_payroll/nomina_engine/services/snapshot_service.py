    ...
    def capture_catalogs_snapshot(self, planilla: Planilla) -> dict[str, Any]:
            ...
            snapshot["percepciones"].append(
                {
                    ...
                    "techo_anual": str(p.techo_anual) if p.techo_anual is not None else None,
                    "tope_base_gravable": str(p.tope_base_gravable) if p.tope_base_gravable is not None else None,
                    "monto_exento": str(p.monto_exento) if p.monto_exento is not None else None,
        ...
        for d in deducciones:
            deduccion_data = {
                ...
                "techo_anual": str(d.techo_anual) if d.techo_anual is not None else None,
                "tope_base_gravable": str(d.tope_base_gravable) if d.tope_base_gravable is not None else None,
                "monto_exento": str(d.monto_exento) if d.monto_exento is not None else None,
